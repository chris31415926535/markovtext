## code to prepare `one_fish_two_fish` dataset goes here
one_fish_two_fish <- dplyr::tibble(
...
wordfreqs_onefishtwofish_3grams <- markovtext::get_word_freqs(text_input = one_fish_two_fish,
                                                           n_grams = 3)

usethis::use_data(wordfreqs_onefishtwofish_3grams, overwrite = TRUE)
