...
cat_in_the_hat <- dplyr::tibble(text = "the sun did not shine.
...
wordfreqs_catinthehat_3grams <- markovtext::get_word_freqs(text_input = cat_in_the_hat,
                                                    n_grams = 3)

usethis::use_data(wordfreqs_catinthehat_3grams, overwrite = TRUE)
